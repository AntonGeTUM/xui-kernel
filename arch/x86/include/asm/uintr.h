...
static inline bool is_uintr_ongoing(struct task_struct *t)
{
	return false;
}

/* EXPORT_SYMBOL functions */
static inline int uintr_notify(struct file *uvec_f)
{
	return -EINVAL;
}
static inline struct file *uvecfd_fget(int uvec_fd)
{
